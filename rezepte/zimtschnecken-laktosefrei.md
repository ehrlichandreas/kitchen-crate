# Zimtschnecken (laktosefrei) - Kombi: laktosefrei, ohne Sauce
...
- Teig: [`hefeteig-grundrezept.md`](hefeteig-grundrezept.md) - Variante **laktosefrei**
- Füllung: [`fuellung-zimt.md`](fuellung-zimt.md) - Variante **laktosefrei**
...
**Faktor 0,5** (6 Stück, 250 g Mehl, 27,5 g Ei, 3,5 g Hefe) ist die kleinste
praktisch sinnvolle Charge - Rest sind Extras.

## Notizen

- Fehlt eine Zutat? Siehe [`../substitution.md`](../substitution.md)
- Normale Version (mit Sauce): [`zimtschnecken.md`](zimtschnecken.md)
