# Zimtschnecken für die Arbeit - Anlass-Kombi: 27 normal + 6 laktosefrei

**Portionen:** 27 Schnecken normal + 6 laktosefrei, für 25-30 Kollegen, davon 3 laktoseintolerant
**Kategorie:** Backen, Anlass
**Enthält keine Nüsse.**

Ein Bauplan aus fertigen Rezepten: er legt nur Faktoren, Zeiten und Einkauf
fest. Die Rezepte selbst bleiben allgemein.

## Bestandteile

- [`zimtschnecken.md`](zimtschnecken.md) mit **Faktor 2,25** (27 Stück) - Teig,
  Füllung und alle drei Saucen
- [`zimtschnecken-laktosefrei.md`](zimtschnecken-laktosefrei.md) mit
  **Faktor 0,5** (6 Stück), eigene Form
- Saucen: Vanillesauce und Karamell je 1×, Frosting 1,5×
...
ist. Spart die 1,5 h Warten am Morgen; beim Probebacken ähnlich gemacht.
...
- Nach dem Mitbringen: was gut war und was nicht, hier eintragen - das ist der
  Wert dieser Datei für das nächste Mal.
